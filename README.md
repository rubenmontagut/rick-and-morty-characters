...
Para el correcto funcionamiento del proyecto solo debe ejecutar `bun main.ts` en la carpeta donde se encuentra dicho archivo. Esto generará 1 archivo _characters.html_ con una lista de _n_ personajes y _n_ archivos _.html_, uno por personaje. El número _n_ se puede modificar en el archivo _main.ts_.
